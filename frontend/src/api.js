...
export const execute = {
  submit: (language, source_code) =>
    request('/execute/', { method: 'POST', body: { language, source_code } }),
...
export const runtimes = {
  start: (projectId) => request(`/projects/${projectId}/runtime/`, { method: 'POST' }),
  get: (projectId, runtimeId) => request(`/projects/${projectId}/runtime/${runtimeId}`),
  stop: (projectId, runtimeId) => request(`/projects/${projectId}/runtime/${runtimeId}`, { method: 'DELETE' }),
};
